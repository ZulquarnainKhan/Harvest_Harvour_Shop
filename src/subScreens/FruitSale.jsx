    ...
    <div style={{
        ...
        <div>
            ...
            style={{
                ...
                <h1 className="h_name" style={{ marginTop: '-2rem', marginBottom: '2rem' }}>FRUIT <span> MART</span></h1>
                ...
                .map((record) => {
                    return (
                        <>
                            ...
                            <div className="display_all_records_card" key={record.id} style={record.id !== '' && record.title !== '' && record.price !== '' && record.quantity !== '' && record.category!=='vegetable' && record.category!=='cereal' ? {} : { display: "none" }}>
