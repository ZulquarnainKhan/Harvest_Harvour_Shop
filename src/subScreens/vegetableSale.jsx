    ...
    <div style={{
        ...
        <div>
            ...
            style={{
                ...
                <h1 className="h_name" style={{ marginTop: '-2rem', marginBottom: '2rem' }}>VEGETABLE <span> MART</span></h1>
                ...
                {/* <div className="file-card" >
                    <Link className="file-card-icon image" to='/displayImage' style={{fontSize:'1.2rem', fontWeight:'bold'}}>
                        <i class='bx bx-images ' ></i>
                        CREATE
                    </Link>
                    <Link className="file-card-icon video" to='/displayVideo' style={{fontSize:'1.2rem', fontWeight:'bold'}}>
                        <i class='bx bxs-videos ' ></i>
                        UPDATE
                    </Link>
                    <Link className="file-card-icon audio" to='/displayAudio' style={{fontSize:'1.2rem', fontWeight:'bold'}}>
                ...
                .map((record) => {
                    return (
                        <>
                            ...
                            <div className="display_all_records_card" key={record.id} style={record.id !== '' && record.title !== '' && record.price !== '' && record.quantity !== ''&& record.category!=='fruit' && record.category!=='cereal' ? {} : { display: "none" }}>
